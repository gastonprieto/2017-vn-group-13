...
public class IndicadorTest {
	...
	public void setUp() {
		...
		interpretadorDeIndicadores = new InterpretadorDeIndicadores();
		
		nivelDeDeuda = interpretadorDeIndicadores.interpretar("Nivel de deuda", "Cuenta 3");												
	}
	
	  @Test
	  public void alPedirleQueGuardeEmpresasPersiste() {		  
